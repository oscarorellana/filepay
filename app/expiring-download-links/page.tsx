// app/expiring-download-links/page.tsx
      ...
      <div style={S.wrap}>
        ...
        <header style={S.nav}>
          ...
          <nav style={S.navLinks}>
            ...
            <Link href="/paid-file-sharing" style={S.navLink}>Paid file sharing</Link>
        ...
        <section style={S.hero}>
          <div style={S.heroGrid}>
            <div>
              ...
              <div style={S.ctas}>
                <Link href="/" style={S.primary}>Create an expiring link →</Link>
        ...
        <footer style={S.footer}>
          ...
          <div style={S.footLinks}>
            ...
            <Link href="/paid-file-sharing" style={S.footLink}>Paid file sharing</Link>
