    ...
    <main style={styles.page}>
      <div style={styles.card}>
        ...
        {isOkPaid && downloadUrl && (
          <div style={styles.linkBox}>
            ...
            <div style={styles.row}>
              <button type="button" onClick={() => copy(downloadUrl)} style={styles.btnPrimary} disabled={busy}>
            ...
            <div style={styles.hint}>Share this link with anyone. It will expire based on the duration you selected.</div>
          </div>
        )}
        ...
        <div style={styles.row}>
          ...
          {!isOk && (
            <button type="button" onClick={finalize} disabled={busy} style={styles.btnPrimary}>
